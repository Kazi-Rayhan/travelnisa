...
class Settings extends Page implements HasForms
{
    ...
    public function save(): void
    {
        ...
        $validatedData = $this->validate([
            ...
            'site_logo' => 'nullable|file|max:1024',
            'site_favicon' => 'nullable|file|max:512',
        ...
        try {
            ...
            // Handle file uploads without foreach
            if ($validatedData['site_logo']) {
                // Store the uploaded file and save the path
                $validatedData['site_logo'] = $validatedData['site_logo']->store('logos', 'local'); // Store in storage/app/logos
            }

            if ($validatedData['site_favicon']) {
                // Store the uploaded file and save the path
                $validatedData['site_favicon'] = $validatedData['site_favicon']->store('favicons', 'local'); // Store in storage/app/favicons
            }
            ...
            return; // Handle any exceptions here
        }
    }
