...
@section('content')
    <!-- Header Banner -->
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="{{ asset('assets/frontend/img/slider/1.jpg') }}">
        <div class="container">
            <div class="row">
    ...
    <section class="about section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="{{ asset('assets/frontend/img/rooms/8.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 owl-carousel owl-theme">
                    <div class="item">
                        <div class="img"> <img src="{{asset('assets/frontend/img/team/4.jpg')}}" alt=""> </div>
                        <div class="info">
                    ...
                    <div class="item">
                        <div class="img"> <img src="{{asset('assets/frontend/img/team/2.jpg')}}" alt=""> </div>
                        <div class="info">
                            <h6>Olivia Martin</h6>
                    ...
                    <div class="item">
                        <div class="img"> <img src="{{asset('assets/frontend/img/team/5.jpg')}}" alt=""> </div>
                        <div class="info">
                            <h6>Mariana Dana</h6>
                            <p>F&B Manager</p>
                            <div class="social valign">
                    ...
                    <div class="item">
                        <div class="img"> <img src="{{asset('assets/frontend/img/team/3.jpg')}}" alt=""> </div>
                        <div class="info">
                            <h6>Enrico Brown</h6>
                            <p>Head Chef</p>
                            <div class="social valign">
                    ...
                    <div class="item">
                        <div class="img"> <img src="{{asset('assets/frontend/img/team/6.jpg')}}" alt=""> </div>
                        <div class="info">
                            <h6>Victoria Dan</h6>
